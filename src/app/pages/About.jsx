    ...
    return (
        <main className="p-12 bg-neutral-100">
            ...
            <section className="h-auto p-4 md:p-8 lg:p-12 m-4 md:m-8 lg:mx-20 lg:my-12 rounded-xl bg-white">
                ...
                <p className="text-center text-lg font-medium mt-2 w-3/6 m-auto">Misi kami adalah mendidik dan memberdayakan individu untuk mengendalikan masa depan keuangan mereka. Kami membayangkan dunia di mana setiap orang, terlepas dari latar belakang mereka, memiliki pengetahuan dan alat untuk membuat keputusan keuangan yang tepat.</p>
            </section>
            <section className="h-auto p-4 md:p-8 lg:p-12 m-4 md:m-8 lg:mx-20 lg:my-12 rounded-xl bg-white">
